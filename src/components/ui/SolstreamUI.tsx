          ...
          <div className="w-full max-w-xl mb-8 flex items-center justify-center space-x-2">
            <div className="relative flex-1">
              <input
                ...
                className="w-full bg-emerald-500 text-black placeholder-gray-700 rounded-lg py-2 px-4 pr-10 
            ...
            <button className="bg-emerald-500 hover:bg-emerald-600 px-4 py-2 rounded-lg text-black">
              search
            </button>
          </div>
          ...
          <div className="w-full max-w-[1800px] mb-6" ref={dropdownRef}>
            <div className="relative inline-block">
              <button
                ...
                className="bg-emerald-500 hover:bg-emerald-600 px-4 py-2 rounded-lg flex items-center space-x-2 text-black"
              >
              ...
              {showSortDropdown && (
                <div className="absolute top-full mt-1 bg-emerald-500 rounded-lg shadow-lg overflow-hidden z-10 min-w-[200px]">
                  {[
